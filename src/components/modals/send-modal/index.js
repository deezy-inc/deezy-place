        ...
        if (boostRequired) {
            try {
                ...
                if (window.webln) {
                    ...
                    result = await window.webln.sendPayment(
                        data.bolt11_invoice
                    );
            ...
            <div className={clsx(!isMounted && "hide-animated")}>
                ...
                <div className="placebid-form-box">
                    <div className="bid-content">
                        ...
                        {boostRequired && (
                            <span>
                                Sending will require a small lightning payment
                                to boost the utxo value
                                <br />
                                <br />
                            </span>
                        )}
