...
interface NavBarProps {
  ...
  handleDisconnectFromWallet?: () => void;
}

export default function Navbar({ handleConnectWallet, handleDisconnectFromWallet, address }: NavBarProps) {
  return (
                    ...
                    <Menu as="div" className="relative ml-3">
                      <div>
                        <Menu.Button className="flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                          ...
                          <Image className="h-8 w-8 rounded-full border border-yellow-400" src="/nos-ft-logo.png" alt="" width={32} height={32} />
                        </Menu.Button>
                      </div>
                      <Transition
                        as={Fragment}
            ...
            <Disclosure.Panel className="md:hidden">
              <div className="border-t border-gray-700 pt-4 pb-3">
                <div className="flex items-center px-5 sm:px-6">
                  <div className="flex-shrink-0">
                    <Image className="h-10 w-10 rounded-full border border-yellow-400" src="/nos-ft-logo.png" alt="" width={32} height={32} />
                  </div>
                  <div className="ml-3">
                  </div>
                </div>
