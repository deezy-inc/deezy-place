...
const ProductDetailsArea = memo(
  ({
    ...
    const minted = inscription?.created
    ...
    return (
      <SkeletonTheme baseColor="#13131d" highlightColor="#242435">
        <div
          className={clsx("", space === 1 && "rn-section-gapTop", className)}
        >
            ...
            <div className="inscription-wrapper g-5">
              ...
              <div className=" mt_md--50 mt_sm--60">
                <div className="rn-pd-content-area">
                  ...
                  {!inscription?.num && <Skeleton width={140} />}
          ...
          {showAuctionModal && (
            <AuctionModal
              ...
              utxo={{
                ...inscription,
                value: nostr?.value || inscription.value,
              }}
              isSpent={isUtxoSpent}
              onSale={onAuction}
            />
