...
const UserDropdown = () => {
    const { walletName, nostrPaymentsAddress, nostrOrdinalsAddress, onDisconnectHandler: onDisconnect } = useWallet();
                                    ...
                                    {walletName !== "xverse" ? (
                                        <>
                                            ...
                                            <div className="d-flex">
                                                <span className="nostrAddress">{nostrOrdinalsAddress}</span>{" "}
                                                <span className="icon">
                                                    <button
                                                        type="button"
                                                        className="btn-close"
                                        ...
                                        <>
                                            <span className="text">
                                                You can safely receive ordinals inscriptions to this address
                                            </span>
                                            <div className="d-flex">
                                                <span className="nostrAddress">{nostrOrdinalsAddress}</span>{" "}
                                                <span className="icon">
                                            ...
                                            <br />
                                            <span className="text">But regular bitcoin to this address</span>
                                            <div className="d-flex">
                                                <span className="nostrAddress">{nostrPaymentsAddress}</span>{" "}
                                                <span className="icon">
                                                    <button
                                                        type="button"
                                                        className="btn-close"
