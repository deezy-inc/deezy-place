...
export default function SendInscriptionModal({ handleSendInscription, inscription, onClose }: { handleSendInscription: (value: any ) => void, inscription: Utxo | null, onClose: (value: boolean) => void }) {
