...
const NostrBidding = ({ className, space }) => {
            ...
            <div className="container">
                <div className="row mb--20">
                    <div className="col-lg-6 col-md-6 col-sm-6 col-12 mt_mobile--15">
                        <SectionTitle className="mb--0 live-title" {...{ title: "Live Auction" }} />
                    </div>
...
NostrBidding.propTypes = {
    className: PropTypes.string,
    space: PropTypes.oneOf([1, 2]),
};

NostrBidding.defaultProps = {
    space: 1,
};

export default NostrBidding;
